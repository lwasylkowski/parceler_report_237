...
public class OtherModuleClassWithString {
    ...
    @ParcelConstructor
    public OtherModuleClassWithString(int param, long param2, @Deprecated String param3, boolean param4, String param5, double param6) {
        this.param = param;
        this.param2 = param2;
        this.param3 = param3;
        this.param4 = param4;
